...
public class LoaderSeeExecutor implements CommandExecutor{
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		if (LoaderData.showChunk(target, player))
			src.sendMessage(Text.of(TextColors.DARK_GREEN, "Area marked"));
		else
			src.sendMessage(Text.of(TextColors.DARK_PURPLE, "No area chunkloaded"));
